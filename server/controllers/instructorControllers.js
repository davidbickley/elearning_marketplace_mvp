...
export const makeInstructor = async (req, res) => {
    ...
    try {
        ...
        // 2. If user doesn't have Strip account ID yet, then create new
        ...
        // 4. Pre-fill any info, such as email, etc. (optional), then send the url response to frontend
        accountLink = Object.assign(accountLink, {
            "stripe_user[email]": user.email,
        })
        
        // 5. Send the account link as JSON response to frontend
